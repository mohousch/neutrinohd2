...
#define SATIP_SERVERBOX_GUI_OPTION_COUNT 3
const CMenuOptionChooser::keyval SATIP_SERVERBOX_GUI_OPTIONS[SATIP_SERVERBOX_GUI_OPTION_COUNT] =
{
	{ SNeutrinoSettings::SATIP_SERVERBOX_GUI_NEUTRINO, NONEXISTANT_LOCALE, "Neutrino" },
	{ SNeutrinoSettings::SATIP_SERVERBOX_GUI_NEUTRINO_HD, NONEXISTANT_LOCALE, "NeutrinoHD" },
