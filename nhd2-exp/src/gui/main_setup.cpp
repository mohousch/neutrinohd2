...
void CMainSetup::showMenu(void)
{
	...
	mainSettings->addItem(new CMenuForwarderExtended(LOCALE_MAINSETTINGS_KEYBINDING, true, new CRemoteControlSettings(), NULL, CRCInput::RC_red, NEUTRINO_ICON_BUTTON_RED, NEUTRINO_ICON_MENUITEM_REMOTECONTROLSETTINGS, LOCALE_HELPTEXT_REMOTECONTROLSETTINGS ));
...
void CMainSetup::showMenuClassic(void)
{
	...
	// video settings
	mainSettings->addItem(new CMenuForwarder(LOCALE_MAINSETTINGS_VIDEO, true, NULL, new CVideoSettings(), NULL, CRCInput::convertDigitToKey(shortcutMainSettings++), NEUTRINO_ICON_CLASSIC_VIDEOSETTINGS, LOCALE_HELPTEXT_VIDEOSETTINGS));

	// audio settings
	mainSettings->addItem(new CMenuForwarder(LOCALE_MAINSETTINGS_AUDIO, true, NULL, new CAudioSettings(), NULL, CRCInput::convertDigitToKey(shortcutMainSettings++), NEUTRINO_ICON_CLASSIC_AUDIOSETTINGS, LOCALE_HELPTEXT_AUDIOSETTINGS));

	// parentallock
	if(g_settings.parentallock_prompt)
		mainSettings->addItem(new CLockedMenuForwarder(LOCALE_PARENTALLOCK_PARENTALLOCK, g_settings.parentallock_pincode, true, true, NULL, new CParentalLockSettings(), NULL, CRCInput::convertDigitToKey(shortcutMainSettings++), NEUTRINO_ICON_CLASSIC_PARENTALLOCKSETTINGS, LOCALE_HELPTEXT_PARENTALLOCK));
	else
		mainSettings->addItem(new CMenuForwarder(LOCALE_PARENTALLOCK_PARENTALLOCK, true, NULL, new CParentalLockSettings(), NULL, CRCInput::convertDigitToKey(shortcutMainSettings++), NEUTRINO_ICON_CLASSIC_PARENTALLOCKSETTINGS, LOCALE_HELPTEXT_PARENTALLOCK));

	// network settings
	mainSettings->addItem(new CMenuForwarder(LOCALE_MAINSETTINGS_NETWORK, true, NULL,  CNetworkSettings::getInstance(), NULL, CRCInput::convertDigitToKey(shortcutMainSettings++), NEUTRINO_ICON_CLASSIC_NETWORKSETTINGS, LOCALE_HELPTEXT_NETWORKSETTINGS));

	// recording settings
	mainSettings->addItem(new CMenuForwarder(LOCALE_MAINSETTINGS_RECORDING, true, NULL, new CRecordingSettings(), NULL, CRCInput::convertDigitToKey(shortcutMainSettings++), NEUTRINO_ICON_CLASSIC_RECORDINGSETTINGS, LOCALE_HELPTEXT_RECORDINGSETTINGS));

	// movieplayer settings
	mainSettings->addItem(new CMenuForwarder(LOCALE_MAINSETTINGS_STREAMING, true, NULL, new CMoviePlayerSettings(), NULL, CRCInput::convertDigitToKey(shortcutMainSettings++), NEUTRINO_ICON_CLASSIC_MOVIEPLAYERSETTINGS, LOCALE_HELPTEXT_MOVIEPLAYERSETTINGS));

	//OSD settings
	mainSettings->addItem(new CMenuForwarder(LOCALE_MAINSETTINGS_OSD, true, NULL, new COSDSettings(), NULL, CRCInput::convertDigitToKey(shortcutMainSettings++), NEUTRINO_ICON_CLASSIC_OSDSETTINGS, LOCALE_HELPTEXT_OSDSETTINGS));

	// vfd/lcd settings
	//if(CVFD::getInstance()->has_lcd)
		mainSettings->addItem(new CMenuForwarder(LOCALE_MAINSETTINGS_LCD, true, NULL, new CLCDSettings(), NULL, CRCInput::convertDigitToKey(shortcutMainSettings++), NEUTRINO_ICON_CLASSIC_LCDSETTINGS, LOCALE_HELPTEXT_VFDSETTINGS));	

	// remote control settings
	mainSettings->addItem(new CMenuForwarder(LOCALE_MAINSETTINGS_KEYBINDING, true, NULL, new CRemoteControlSettings(), NULL, CRCInput::RC_red, NEUTRINO_ICON_CLASSIC_REMOTECONTROLSETTINGS, LOCALE_HELPTEXT_REMOTECONTROLSETTINGS));

	// audioplayer settings
	mainSettings->addItem(new CMenuForwarder(LOCALE_AUDIOPLAYERSETTINGS_GENERAL, true, NULL, new CAudioPlayerSettings(), NULL, CRCInput::RC_green, NEUTRINO_ICON_CLASSIC_AUDIOPLAYERSETTINGS, LOCALE_HELPTEXT_AUDIOPLAYERSETTINGS));
	
	// pictureviewer settings
	mainSettings->addItem(new CMenuForwarder(LOCALE_PICTUREVIEWERSETTINGS_GENERAL, true, NULL, new CPictureViewerSettings(), NULL, CRCInput::RC_yellow, NEUTRINO_ICON_CLASSIC_PICTUREVIEWERSETTINGS, LOCALE_HELPTEXT_PICTUREVIEWERSETTINGS));

	// misc settings
	mainSettings->addItem(new CMenuForwarder(LOCALE_MAINSETTINGS_MISC, true, NULL, new CMiscSettings(), NULL, CRCInput::RC_blue, NEUTRINO_ICON_CLASSIC_MISCSETTINGS, LOCALE_HELPTEXT_MISCSETTINGS));

	//HDD settings
	mainSettings->addItem(new CMenuForwarder(LOCALE_HDD_SETTINGS, true, NULL, new CHDDMenuHandler(), NULL, CRCInput::convertDigitToKey(shortcutMainSettings++), NEUTRINO_ICON_CLASSIC_HDDSETTINGS, LOCALE_HELPTEXT_HDDSETTINGS));
