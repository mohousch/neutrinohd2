...
{
	if(paint_Foot)
		::paintFoot(cFrameBox.iX, cFrameBox.iY + cFrameBox.iHeight - footInfoHeight - fheight, cFrameBox.iWidth, fheight, cFrameBox.iWidth/fbutton_count, fbutton_count, fbutton_labels);
}
