...
typedef enum {
	...
	LOCALE_COLORTHEMEMENU_PINKY_THEME,
	LOCALE_COLORTHEMEMENU_NEUTRINOHD2_THEME,
	LOCALE_COLORTHEMEMENU_GIGABLUE_THEME,
	...
	LOCALE_EXTRA_MAINMENU_DESIGN,
	LOCALE_EXTRA_MAINMENU_DESIGN_SMART,
	LOCALE_EXTRA_MAINMENU_DESIGN_STANDARD,
